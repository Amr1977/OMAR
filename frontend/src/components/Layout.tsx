    ...
    <div className="min-h-screen bg-[var(--color-bg)]">
      ...
      <footer className="border-t border-[var(--color-border)] bg-[var(--color-surface)]">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between text-xs text-[var(--color-muted)]">
          ...
          <div className="flex items-center gap-3">
            <a href="https://amrlotfy.et3am.com" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 hover:text-[var(--color-primary)] transition-colors">
